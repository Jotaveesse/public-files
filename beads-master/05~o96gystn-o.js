(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    (e) => {
                ...
                try {
                    ...
                    );
                    {
                        ...
                        e.r(66962).useBeadStore.getState().showAlert({
                            title: "数据库读取失败",
                            content:
                                "本地数据库读取失败！可能由于无痕模式或存储空间不足。这会导致您的历史设计无法自动恢复。",
                            details: l,
                            type: "warning",
                            showCancel: !1,
                        });
                ...
                try {
                    ...
                    );
                    {
                        ...
                        e.r(66962).useBeadStore.getState().showAlert({
                            title: "设计保存失败",
                            content:
                                "本地数据库写入失败！您的拼豆设计可能无法自动保存，请检查浏览器存储空间或退出隐私模式。",
                            details: l,
                            type: "warning",
                            showCancel: !1,
                        });
        ...
        function l(e, t) {
            let { data: l, width: i, height: r } = e,
                { data: a, width: s, height: o } = t,
                ...
                p = [],
                h = (e) => {
                    e >= 0 && e < d && !u[e] && c(e) && ((u[e] = 1), p.push(e));
                };
            for (let e = 0; e < i; e++) (h(e), h((r - 1) * i + e));
            for (let e = 1; e < r - 1; e++) (h(e * i), h(e * i + i - 1));
            let g = 0;
            for (; g < p.length; ) {
                let e = p[g++],
                    t = Math.floor(e / i),
        ...
        function i(e) {
            ...
            for (let e = 0; e < r.length; e++)
                r[e].length > s && ((s = r[e].length), (a = e));
            let o = [];
            for (let e = 0; e < r.length; e++) e !== a && o.push(...r[e]);
            return o;
        }
    },
    1872,
        ...
        class a extends l {
            ...
            constructor(e) {
                if (
                    (super(e),
                    (this.gridSnap = !0),
                    e && (Object.assign(this, e), e.gridData))
                )
                    if (Array.isArray(e.gridData))
                        this.gridData = e.gridData.map((e) =>
                            Array.isArray(e)
                                ? e.map((e) =>
                                      e
                                          ? e instanceof t.BeadColor
                                              ? e
                                              : new t.BeadColor(e)
                                          : null,
                                  )
                    ...
                    else if ("string" == typeof e.gridData)
                        try {
                            const l = JSON.parse(e.gridData);
                            Array.isArray(l)
                                ? (this.gridData = l.map((e) =>
                                      Array.isArray(e)
                                          ? e.map((e) =>
                                                e
                                                    ? e instanceof t.BeadColor
            ...
            rasterize(e, t, l) {
                ...
                return (this.blendOntoGrid(i, e, t, l), i);
            }
        }
        (e.s(["PixelStampSticker", 0, a], 87344),
            e.s(
                [
                    "Drawing",
                    0,
                    class {
                        ...
                        constructor(e) {
                            if (e) {
                                if ((Object.assign(this, e), e.gridData))
                                    if (Array.isArray(e.gridData))
                                        this.gridData = e.gridData.map((e) =>
                                            Array.isArray(e)
                                                ? e.map((e) =>
                                ...
                                e.stickers &&
                                    (this.stickers = e.stickers.map((e) => {
                                        if (!e) return e;
                                        let t =
                                            e.type ||
                                            (void 0 !== e.text
                        ...
                        flattenSticker(e, t) {
                            ...
                            if (-1 === l) return;
                            let i = this.stickers[l].rasterize(
                                t,
                                this.width,
                                this.height,
                            );
    ...
    (e) => {
        ...
        let t = (0, e.i(71414).create)()((e) => ({
            ...
            openMediaExtractor: (t = "", l = "xiaohongshu") =>
                e({
    ...
    (e) => {
            ...
            for (let l = 0; l < e.length; l++) {
                ...
                if (i)
                    for (let e = 0; e < i.length; e++) {
                        let l = i[e];
                        l?.id && t.set(l.id, (t.get(l.id) || 0) + 1);
                    }
            }
            return t;
        }
        ...
        function A(e) {
            let { paletteColors: t, colorUsageStats: l, targetCount: i } = e,
                r = [],
                a = new Map();
            for (let e of t) {
                a.set(e.id, e);
            ...
            for (; c.length > o; ) {
                ...
                for (let l = 0; l < c.length; l++)
                    for (let i = l + 1; i < c.length; i++) {
                        let r = (function (e, t) {
                            let l = (0, w.deltaE2000)(e.lab, t.lab),
                                i =
                                    (e.saliency * t.saliency) /
                                    (e.saliency + t.saliency),
                                r = Math.pow(l, 3.2),
                ...
                let [l, i] = t,
                    ...
                    n = s ? a : r,
                    u = s ? i : l;
                for (let [e, t] of d.entries()) t === n.id && d.set(e, o.id);
                ((o.count += n.count),
                    (o.saliency =
                        Math.max(o.saliency, n.saliency) +
                        0.3 * Math.min(o.saliency, n.saliency)),
                    c.splice(u, 1));
            }
            ...
            for (let e of n) {
                ...
                if (t) {
                    ...
                    r && ((l = r), (i = (0, w.deltaE2000)(e.lab, b(r))));
                }
                if (!l)
                    for (let t of p) {
                ...
                l && (h.set(e.id, l), (g += i * e.count), (f += e.count));
            }
            let m = f > 0 ? g / f : 0;
            return {
                simplifiedPalette: u,
        ...
        e.s(["reducePaletteByPerceptualLoss", 0, A], 7587);
        class P {
            worker = null;
          ...
          `,
                        ...
                        console.warn(
                            "[WorkerComputeBus] 动态创建 Web Worker 降级主线程:",
                            e,
                        );
                    }
            }
            handleWorkerMessage(e) {
                let { id: t, success: l, result: i, error: r } = e.data,
            ...
            B = [
                {
                    ...
                    height: 8,
                    gridData: [
                        [null, v, v, null, null, null, v, v, null],
                        [v, v, v, v, null, v, v, v, v],
                        [v, v, v, v, v, v, v, v, v],
                        [v, v, v, v, v, v, v, v, v],
                        [null, v, v, v, v, v, v, v, null],
                        [null, null, v, v, v, v, v, null, null],
                        [null, null, null, v, v, v, null, null, null],
                ...
                },
                {
                    ...
                    height: 9,
                    gridData: [
                        [null, null, null, null, C, null, null, null, null],
                        [null, null, null, C, C, C, null, null, null],
                        [C, null, C, C, C, C, C, null, C],
                        [null, C, C, C, C, C, C, C, null],
                        [null, null, C, C, C, C, C, null, null],
                        [null, null, C, C, C, C, C, null, null],
                        [null, C, C, C, null, C, C, C, null],
                        [C, C, C, null, null, null, C, C, C],
                        [C, null, null, null, null, null, null, null, C],
                    ],
                },
                {
                    id: "classic-mushroom",
                    ...
                    gridData: [
                        ...
                        [null, null, null, D, v, v, v, v, D, null, null, null],
                        [null, null, D, v, v, k, k, v, v, D, null, null],
                        [null, D, v, k, k, k, k, k, k, v, D, null],
                        [null, D, v, k, k, v, v, k, k, v, D, null],
                        [D, v, v, v, v, v, v, v, v, v, v, D],
                        [D, v, v, D, D, D, D, D, D, v, v, D],
                        [null, D, D, k, k, D, D, k, k, D, D, null],
                        [null, null, D, k, k, k, k, k, k, D, null, null],
                        [null, null, D, k, D, k, k, D, k, D, null, null],
                        [null, null, D, k, k, k, k, k, k, D, null, null],
                        [null, null, null, D, D, D, D, D, D, null, null, null],
                    ],
                },
                {
                    id: "emoji-smile",
                    ...
                    gridData: [
                        ...
                        [C, C, C, C, C, C, C, C, C, C],
                        [C, C, D, C, C, C, C, D, C, C],
                        [C, C, null, D, D, D, D, null, C, C],
                        [null, C, C, null, null, null, null, C, C, null],
                        [null, null, C, C, C, C, C, C, null, null],
                        [
                            null,
                            null,
                ...
                },
                {
                    ...
                    height: 9,
                    gridData: [
                        [null, null, T, T, null, T, T, null, null],
                        [null, T, T, T, T, T, T, T, null],
                        [T, T, T, T, T, T, T, T, T],
                        [T, T, T, T, T, T, T, T, T],
                        [null, T, T, T, D, T, T, T, null],
                        [T, T, T, T, D, T, T, T, T],
                        [T, T, T, T, D, T, T, T, T],
                        [null, T, T, T, D, T, T, T, null],
                        [null, null, T, T, D, T, T, null, null],
                    ],
                },
            ];
        function L(e) {
            ...
            return "text" === t
                ...
                : "pixel_stamp" === t
                  ? new x.PixelStampSticker({
                        ...e,
                        type: "pixel_stamp",
                    })
                  : e;
        }
        e.s(["BUILTIN_ASSETS", 0, B, "getTemplatePixelGrid", 0, M], 57917);
        let E = null,
            O = null,
            _ = !1,
            N = "",
            ...
            R = (e, t) => ({
                ...
                saveCustomStamp: async (l, i = "custom") => {
                    let { pendingAssetGrid: r, customStamps: a } = t();
                    if (!r || 0 === r.length) return null;
                    let s = x.PixelStampSticker.trimGrid(r);
                    if (0 === s.length) return null;
                    let o = s.map((e) =>
                            e
                                ? e.map((e) => (e ? new S.BeadColor(e) : null))
                                : [],
                        ),
                ...
                addPixelStampInstance: (l) => {
                    t().pushHistory();
                    let { processedPixels: i, stickers: r } = t(),
                        a = 25,
                        s = 25;
                    i &&
                        i.length > 0 &&
                        ((s = Math.floor(i.length / 2)),
                        (a = Math.floor((i[0]?.length || 0) / 2)));
                ...
                addPixelStampSticker: (l) => {
                    ...
                    if (!r) return;
                    t().pushHistory();
                    let { processedPixels: a, stickers: s } = t(),
                        o = 25,
                        n = 25;
                    a &&
                        a.length > 0 &&
                        ((n = Math.floor(a.length / 2)),
                        (o = Math.floor((a[0]?.length || 0) / 2)));
                    let d = M(r),
                    ...
                    e({
                        stickers: r.map((e) => {
                            if (e.id === l) {
                                let t = e.type;
                                if ("text" === t)
                                    return new y.TextSticker({
                                        ...e,
                                        ...i,
                                    });
                                if ("pixel_stamp" === t)
                                    return new x.PixelStampSticker({
                                        ...e,
                                        ...i,
                                    });
                            }
                ...
                deleteSticker: (l) => {
                    t().pushHistory();
                    let { stickers: i, selectedStickerId: r } = t();
                    e({
                ...
                bakeAllStickers: () => {
                    ...
                    if (!l || !r) return;
                    t().pushHistory();
                    let { layers: a, activeLayerId: s } = t(),
                        o = l.length,
                        n = l[0]?.length || 0;
                    if (a && a.length > 0) {
                        let t = s || a[0].id,
                ...
                flattenSticker: (l) => {
                    ...
                    if ("function" == typeof c.blendOntoGrid)
                        c.blendOntoGrid(f, u, g, h);
                ...
                getBlendedCanvas: () => {
                    ...
                    if (!i && s.length > 0) {
                        let e = s.map(L),
                            l =
                                o.paletteId && r.ALL_PALETTES[o.paletteId]
                                    ? o.paletteId
                                    : "mard",
                            i = t().getPalette(l);
                        e.forEach((e) => {
        ...
        class z {
            ...
            getCtx() {
                ...
                return (
                    V && "suspended" === V.state && V.resume().catch(() => {}),
                    V
                );
            }
            playClick(e = 0) {
            ...
            getSteamBuffer() {
                ...
                let e = this.getCtx();
                if (!e) return null;
                let t = e.sampleRate || 44100,
                    l = 2 * t,
                    i = e.createBuffer(1, l, t),
                    r = i.getChannelData(0);
                for (let e = 0; e < l; e++) r[e] = 2 * Math.random() - 1;
                return ((this.steamBuffer = i), i);
            }
            startSteam() {
                let e = this.getCtx();
                if (e && !this.steamNoiseNode)
                    try {
                        let t = e.currentTime,
                        ...
                        ((this.steamNoiseNode = e.createBufferSource()),
                            ...
                            this.steamFilterNode.frequency.setValueAtTime(
                                1400,
                                t,
                            ),
                            ...
                            this.steamGainNode.gain.linearRampToValueAtTime(
                                0.12,
                                t + 0.3,
                            ),
            ...
            updateSteam(e) {
                let t = this.getCtx();
                if (t && this.steamFilterNode && this.steamGainNode)
                    try {
                        let l = t.currentTime,
                            i = 1000 + 1200 * Math.min(1, e);
                        this.steamFilterNode.frequency.setTargetAtTime(
                            i,
                            l,
                            0.1,
                        );
            ...
            stopSteam() {
                let e = this.getCtx();
                if (e && this.steamNoiseNode && this.steamGainNode)
                    try {
                        let t = e.currentTime;
                        (this.steamGainNode.gain.cancelScheduledValues(t),
                            this.steamGainNode.gain.setValueAtTime(
                                this.steamGainNode.gain.value,
                                t,
                            ),
                            this.steamGainNode.gain.exponentialRampToValueAtTime(
                                0.001,
                                t + 0.3,
                            ));
            ...
            playSuccess() {
                ...
                if (e)
                    try {
                        let t = e.currentTime;
                        [261.63, 329.63, 392, 523.25].forEach((l, i) => {
        ...
        let H = z.getInstance();
        e.s(["AudioEngine", 0, z, "audioEngine", 0, H], 43669);
        let j = "hand";
        function U(e, t, l, i) {
            let r = e.length,
                a = e[0]?.length || 0,
        ...
        class q {
            static slice(e, t = 28, l = 28) {
                let i = Math.max(4, Math.floor(t)),
                    ...
                    s = a > 0 && Array.isArray(e[0]) ? e[0].length : 0;
                if (0 === a || 0 === s)
                    return {
                        totalRows: 0,
                        totalCols: 0,
        ...
        e.s(["PegboardSlicer", 0, q], 89881);
        let Y = null,
            X = null,
            Q = async (e, t) => {
                Y = t;
                try {
                    let l = JSON.stringify(t, (e, t) =>
                        t instanceof Map
                            ? {
                                  __isMap: !0,
                    ...
                    try {
                        ...
                        (console.warn(
                            "[PixelBead Store] 写入 IndexedDB 失败，降级写入 localStorage:",
                            t,
                        ),
                    ...
                    console.warn(
                        "[PixelBead Store] 持久化写入失败，可能存储空间不足:",
                        e,
                    );
                }
            },
                            ...
                            ...((t, l) => ({
                                ...
                                setImage: async (i, r) => {
                                    ...
                                    let a = i,
                                        s = r;
                                    try {
                                        let { optimizeImageDensity: t } =
                                                await e.A(4412),
                                            l = await t(r || i, 1000000);
                                        (l.optimizedSrc && (a = l.optimizedSrc),
                                            l.imageData && (s = l.imageData));
                                    } catch (e) {
                                        console.warn(
                                            "[PixelBead] 像素密度控制降级使用原图:",
                                            e,
                                        );
                                    }
                                    let o = 52,
                                        ...
                                        ((r.onload = () => {
                                            ...
                                            (a &&
                                                ...
                                                l().processedPixels &&
                                                    ...
                                                    t({
                                                        templatePixels:
                                                            l().processedPixels?.map(
                                                                (e) => [...e],
                                                            ),
                                                        templateStats: l().stats
                                                            ? new Map(l().stats)
                                                            : null,
                                                    }),
                                                l().processedPixels ||
                                ...
                                processImage: async () => {
                                    ...
                                    if (i) {
                                        ...
                                        try {
                                            ...
                                            try {
                                                if (!g) {
                                                    ...
                                                    ((g = i),
                                                        (i.onerror = (e) => {
                                                            (console.error(
                                                                "[PixelBead AI Engine Critical Error]:",
                                                                e,
                                                            ),
                                                                t({
                                                                    isProcessing:
                                                            ...
                                                            (l().showAlert({
                                                                title: "像素引擎崩溃",
                                                                content:
                                                                    "图像像素化处理引擎在运行时崩溃，建议您更换现代浏览器 (如 Chrome, Safari) 后重试。",
                                                                details: i,
                                                                type: "error",
                                                                showCancel: !1,
                                                            }),
                                                ...
                                                l().showAlert({
                                                    title: "像素引擎启动失败",
                                                    content:
                                                        "图像像素化处理引擎启动失败！您的浏览器环境可能受限或不支持 Web Worker。建议您更换现代浏览器 (如 Chrome, Safari) 或关闭无痕/隐私模式后重试。",
                                                    details: e,
                                                    type: "error",
                                                    showCancel: !1,
                                                });
                                            ...
                                            (console.error(
                                                "[PixelBead Performance Engine] 转换异常:",
                                                e,
                                            ),
                                                t({
                                                    isProcessing: !1,
                                ...
                                setProcessedData: (e, l) =>
                                    t((t) => {
                                        let i = t.layers || [],
                                            r = t.activeLayerId || i[0]?.id;
                                        if (i.length > 0 && r) {
                                            let l = i.map((t) =>
                                                    t.id === r
                                                        ? {
                                ...
                                fitToScreen: (e, i) => {
                                    let { processedPixels: r, canvasSize: a } =
                                        l();
                                    if (!r) return;
                                    let s = e ?? a?.width,
                                        o = i ?? a?.height;
                                ...
                                removeBackground: async () => {
                                    let { imageSource: r, imageData: a } = l();
                                    if (r && a) {
                                        t({
                                ...
                                setSidebarOpen: (t) => {
                                    let { useEditorUiStore: l } = e.r(97260);
                                    l.getState().setSidebarOpen(t);
                                },
                                toggleSidebar: () => {
                                    let { useEditorUiStore: t } = e.r(97260);
                                ...
                                openShareModal: (t, l) => {
                                    let { useEditorUiStore: i } = e.r(97260);
                                    ...
                                    t((e) => {
                                        let t = new o.Drawing({
                                            ...
                                            title:
                                                c ||
                                                (0, u.t)(
                                                    "library.untitledDrawing",
                                                ),
                                            paletteId: n,
                                            width: a,
                                            height: s,
                                            pixelCount: Array.from(
                                                y.values(),
                                            ).reduce((e, t) => e + t, 0),
                                            gridData: m,
                                            stickers: d || [],
                                ...
                                setCurrentDrawing: (e) => {
                                    ...
                                    t({
                                        ...
                                        templatePixels: e.gridData.map((e) => [
                                            ...e,
                                        ]),
                                        stats: i,
                                ...
                                setAppActiveTab: (t) => {
                                    let { useAppTabStore: l } = e.r(15353);
                                ...
                                setReferenceImage: (e) => {
                                    (t({
                                        ...
                                        e
                                            ? i.idbStore
                                                  .set(
                                                      "pixel-bead-reference-image-raw",
                                                      e,
                                                  )
                                                  .catch((e) => {
                                                      console.warn(
                                                          "[PixelBead Store] 保存参考图失败:",
                                                          e,
                                                      );
                                                  })
                                            : i.idbStore
                                                  ...
                                                  .catch((e) => {
                                                      console.warn(
                                                          "[PixelBead Store] 删除参考图失败:",
                                                          e,
                                                      );
                                                  }));
                                },
                                setReferenceOpacity: (e) =>
                                    t({
                                        referenceOpacity: e,
                                    }),
                                setOverlayBeadOpacity: (e) =>
                                    t({
                                        overlayBeadOpacity: e,
                                    }),
                                setOverlayTextOpacity: (e) =>
                                    t({
                                ...
                                hydrateCustomPalettes: async () => {
                                    try {
                                        let e = await i.idbStore.get(
                                            "pixel-bead-custom-palettes",
                                        );
                                        if (e) {
                                            t({
                                                customPalettes: e,
                                ...
                                getPalette: (e) => {
                                    let { customPalettes: t } = l();
                                    if (e && e.startsWith("custom_")) {
                                        let l = t.find((t) => t.id === e);
                                        if (l) return l;
                                    }
                                    return (
                                        r.ALL_PALETTES[e] || r.ALL_PALETTES.mard
                                    );
                                },
                            ...
                            ...((t, l) => ({
                                ...
                                reducePaletteColors: (e) => {
                                    let {
                                        ...
                                        n = a && a.length > 0 ? a : [];
                                    if (!i || 0 === i.size || 0 === n.length)
                                        return;
                                    let d = o || s.paletteId || "mard",
                                        { colorMapping: c, mergedCount: u } = A(
                                            {
                                                paletteColors:
                                                    (
                                                        r.ALL_PALETTES[d] ||
                            ...
                            ...((e, t) => ({
                                ...
                                showUnfocusedSymbols: (() => {
                                    try {
                                        if ("u" > typeof localStorage) {
                                            let e = localStorage.getItem(
                                                "pixel_focus_show_unfocused_symbols",
                                            );
                                ...
                                batchSetBeadsComplete: (l, i) => {
                                    ...
                                    if (
                                        s?.enabled &&
                                        null !== s.activeSliceIndex &&
                                        s.activeSliceIndex >= 0
                                    ) {
                                        let e = s.boardWidth || 26,
                                            t = s.boardHeight || 26,
                                            l = Math.ceil(d / e),
                                            i = Math.floor(
                                                s.activeSliceIndex / l,
                                            ),
                            ...
                            ...((e, t) => ({
                                ...
                                copySelection: () => {
                                    ...
                                    let S = {
                                        ...
                                        b = new Set();
                                    for (let e = S.y; e < S.y + S.h; e++)
                                        for (let t = S.x; t < S.x + S.w; t++)
                                            b.add(`${t},${e}`);
                        ...
                        storage: {
                            getItem: async (e) => {
                                ...
                                try {
                                    ...
                                    console.warn(
                                        "[PixelBead Store] 从 IndexedDB 读取失败，尝试读取 localStorage:",
                                        e,
                                    );
                                }
                                if (!t)
                                    try {
                                        ...
                                        console.warn(
                                            "[PixelBead Store] 从 localStorage 读取失败:",
                                            e,
                                        );
                                    }
                                if (!t) return null;
                                try {
                                    ...
                                    let s = new Map();
                                    return (
                                        Object.values(r.ALL_PALETTES).forEach(
                                            (e) => {
                                                e.colors.forEach((e) => {
                                                    s.has(e.id) ||
                                                        s.set(e.id, e);
                            ...
                            removeItem: async (e) => {
                                try {
                                    ...
                                    console.warn(
                                        "[PixelBead Store] 从 IndexedDB 删除失败:",
                                        e,
                                    );
                                }
                                try {
                                    ...
                                    console.warn(
                                        "[PixelBead Store] 从 localStorage 删除失败:",
                                        e,
                                    );
                                }
                            },
